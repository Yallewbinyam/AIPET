...
**Module:** HTTP | **Target:** localhost

Default credentials valid — 24 credential set(s) found
...
8 interface(s) found — 8 exposing sensitive data
...
2 API(s) found — 2 exposing sensitive data without authentication
...
3 sensitive data pattern(s) found in MQTT traffic
